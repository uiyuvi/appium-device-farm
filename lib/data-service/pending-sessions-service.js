...
exports.removePendingSession = exports.addNewPendingSession = void 0;
const db_1 = require("./db");
function addNewPendingSession(capability) {
    return __awaiter(this, void 0, void 0, function* () {
        db_1.PendingSessionsModel.insert(capability);
    });
}
exports.addNewPendingSession = addNewPendingSession;
function removePendingSession(sessionCapabilityId) {
    return __awaiter(this, void 0, void 0, function* () {
        db_1.PendingSessionsModel.chain().find({ capability_id: sessionCapabilityId }).remove();
    });
}
